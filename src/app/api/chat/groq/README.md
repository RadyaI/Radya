# 🧠 AI Chat API (Groq + Next.js)

Simple AI Chat API built with **Next.js App Router** and **Groq LLM**, designed for personal websites and public demos with built-in **rate limiting & abuse protection**.
...
This endpoint acts as a **server-side proxy** to Groq’s Chat Completion API.
...
* **Per client fingerprint**
  ...
  * IP address
  * User-Agent
* Rate limit is applied **before** calling Groq (no token cost)
