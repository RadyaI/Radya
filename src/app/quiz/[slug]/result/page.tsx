...
import { getQuizResultById } from '@/utils/firebase-quiz';
      ...
      <div className="max-w-3xl mx-auto bg-white border-2 border-black shadow-[8px_8px_0px_0px_#000] p-8 md:p-12 relative min-h-[80vh]">
        ...
        <div className="space-y-4 mb-12">
           ...
           {result.answers.map((ans: any, idx: number) => (
             <div key={idx} className="item-row p-4 border border-black/20 bg-gray-50 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                <div className="flex-1">
                   ...
                   <p className="text-sm font-medium text-gray-800">You chose: {ans.selectedOption}</p>
                </div>
                {!ans.isCorrect && (
                   <div className="text-xs font-mono text-red-600 md:text-right border-l-2 md:border-l-0 border-red-200 pl-3 md:pl-0">
                      Correct answer:<br/>
