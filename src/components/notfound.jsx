...
export default function NotFound() {
    ...
    return (
        <>
            <Cursor/>
            <div className="cursor-none relative min-h-screen w-full bg-[#0A0A0A] flex items-center justify-center overflow-hidden font-sans text-white perspective-[2000px]">
