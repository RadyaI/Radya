...
export const quizData: QuizSet[] = [
  ...
  {
    slug: "basic-programming-dummy",
    title: "Basic Programming Quiz",
    description: "Soal dummy untuk latihan logika dan konsep dasar pemrograman",
    ...
    questions: [
      {
        id: 1,
        type: "multiple-choice",
        q: "Apa fungsi utama dari variabel dalam pemrograman?",
        options: [
        ...
        correctIndex: 0,
        explanation: "Variabel digunakan untuk menyimpan data yang dapat digunakan dan diubah selama program berjalan."
      },
      {
        id: 2,
        type: "multiple-choice",
        q: "Tipe data manakah yang digunakan untuk menyimpan nilai true atau false?",
        options: [
          "String",
          "Number",
          "Boolean",
      ...
      },
      {
        id: 3,
        type: "multiple-choice",
        q: "Apa hasil dari ekspresi 5 + '5' dalam JavaScript?",
        options: [
          "10",
          "55",
          "Error",
        ...
        correctIndex: 1,
        explanation: "JavaScript melakukan type coercion sehingga angka 5 dikonversi menjadi string dan digabungkan."
      },
      {
        id: 4,
        type: "multiple-choice",
        q: "Keyword apa yang digunakan untuk membuat perulangan di banyak bahasa pemrograman?",
        options: [
          "if",
          "switch",
          "for",
        ...
        correctIndex: 2,
        explanation: "Perulangan biasanya menggunakan keyword seperti for atau while."
      },
      {
        id: 5,
        type: "multiple-choice",
        q: "Apa tujuan utama dari fungsi (function)?",
        options: [
          "Menyimpan data",
          "Mengulang kode tanpa struktur",
          "Membagi kode menjadi bagian yang bisa digunakan ulang",
          "Menjalankan program tanpa error",
          "Menghapus variabel"
        ],
        correctIndex: 2,
        explanation: "Fungsi membantu membuat kode lebih terstruktur dan reusable."
      },
      {
        id: 6,
        type: "essay",
        q: "Jelaskan perbedaan antara var, let, dan const dalam JavaScript.",
        answerKey: "var bersifat function scope, sedangkan let dan const block scope. const tidak bisa di-reassign.",
        explanation: "Pemahaman scope dan mutability penting untuk menghindari bug."
      },
      {
        id: 7,
        type: "essay",
        q: "Apa yang dimaksud dengan algoritma?",
        answerKey: "Algoritma adalah langkah-langkah logis dan terstruktur untuk menyelesaikan suatu masalah.",
        explanation: "Algoritma tidak tergantung bahasa pemrograman."
      },
      {
        id: 8,
        type: "essay",
        q: "Sebutkan contoh penggunaan array dalam kehidupan sehari-hari.",
        answerKey: "Contoh: daftar nama siswa, daftar nilai, daftar barang belanja.",
        explanation: "Array digunakan untuk menyimpan kumpulan data sejenis."
      },
      {
        id: 9,
        type: "essay",
        q: "Apa yang terjadi jika sebuah loop tidak memiliki kondisi berhenti?",
        answerKey: "Program akan mengalami infinite loop.",
        explanation: "Infinite loop dapat menyebabkan program crash atau hang."
      },
      {
        id: 10,
        type: "essay",
        q: "Mengapa debugging penting dalam proses pengembangan software?",
        answerKey: "Untuk menemukan dan memperbaiki kesalahan agar program berjalan sesuai harapan.",
        explanation: "Debugging membantu meningkatkan kualitas dan stabilitas aplikasi."
      }
    ]
  }
